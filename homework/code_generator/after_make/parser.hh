...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_INT = 30,                  // INT
    TOK_CHAR = 31,                 // CHAR
    TOK_STRING = 32,               // STRING
    TOK_DO = 33,                   // DO
    TOK_WHILE = 34,                // WHILE
    TOK_FOR = 35,                  // FOR
    TOK_CONTINUE = 36,             // CONTINUE
    TOK_REPEAT = 37,               // REPEAT
    TOK_IF = 38,                   // IF
    TOK_ELSE = 39,                 // ELSE
    TOK_CASE = 40,                 // CASE
    TOK_BREAK = 41,                // BREAK
    TOK_EXIT = 42,                 // EXIT
    TOK_CLASS = 43,                // CLASS
    TOK_OBJECT = 44,               // OBJECT
    TOK_DEF = 45,                  // DEF
    TOK_NULL = 46,                 // NULL
    TOK_PRINT = 47,                // PRINT
    TOK_PRINTLN = 48,              // PRINTLN
    TOK_RETURN = 49,               // RETURN
    TOK_TO = 50,                   // TO
    TOK_TYPE = 51,                 // TYPE
    TOK_VAL = 52,                  // VAL
    TOK_VAR = 53,                  // VAR
    TOK_ID = 54,                   // ID
    TOK_CONSTANT_BOOLEAN = 55,     // CONSTANT_BOOLEAN
    TOK_CONSTANT_INTEGER = 56,     // CONSTANT_INTEGER
    TOK_CONSTANT_CHAR = 57,        // CONSTANT_CHAR
    TOK_CONSTANT_STRING = 58,      // CONSTANT_STRING
    TOK_UMINUS = 59                // UMINUS
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_VAR = 53,                              // VAR
        S_ID = 54,                               // ID
        S_CONSTANT_BOOLEAN = 55,                 // CONSTANT_BOOLEAN
        S_CONSTANT_INTEGER = 56,                 // CONSTANT_INTEGER
        S_CONSTANT_CHAR = 57,                    // CONSTANT_CHAR
        S_CONSTANT_STRING = 58,                  // CONSTANT_STRING
        S_UMINUS = 59,                           // UMINUS
        ...
        S_63_2 = 63,                             // $@2
        S_64_3 = 64,                             // $@3
        S_global_declarations = 65,              // global_declarations
        ...
        S_78_8 = 78,                             // $@8
        S_79_9 = 79,                             // $@9
        S_boolean_expr = 80,                     // boolean_expr
        S_block_or_simple = 81,                  // block_or_simple
        S_block = 82,                            // block
        S_83_10 = 83,                            // $@10
        S_constant_and_variable_declarations = 84, // constant_and_variable_declarations
        S_constant_and_variable_declaration = 85, // constant_and_variable_declaration
        S_constant_declaration = 86,             // constant_declaration
        S_variable_declaration = 87,             // variable_declaration
        S_assign_type_optional = 88,             // assign_type_optional
        S_assign_type = 89,                      // assign_type
        S_type = 90,                             // type
        S_declaring_id = 91,                     // declaring_id
        S_statements_optional = 92,              // statements_optional
        S_statements = 93,                       // statements
        S_statement = 94,                        // statement
        S_procedure_invocations = 95,            // procedure_invocations
        S_simple = 96,                           // simple
        S_97_11 = 97,                            // $@11
        S_98_12 = 98,                            // $@12
        S_expressions = 99,                      // expressions
        S_data_type_id = 100,                    // data_type_id
        S_function_invocation = 101,             // function_invocation
        S_comma_separated_expressions = 102,     // comma_separated_expressions
        S_constant_exp = 103                     // constant_exp
      };
    };
